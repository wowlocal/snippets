    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .exportDiagnostics:
            ...
            cell.detailTextLabel?.text = "Plaintext JSON Lines. Operation counts, CloudKit "
                + "callback and scheduler states, sign-in stages and HTTP status codes, paste and clipboard restoration outcomes and timings, and secure-snippet keywords may be included; "
